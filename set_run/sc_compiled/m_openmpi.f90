...
if (myid_world.eq.0)  write(*,*) '__/\\\________/\\\__/\\\\\\\\\\\__/\\\\\\\\\\\\\\\_____/\\\\\\\\\\_____________/\\\\\_        '
if (myid_world.eq.0)  write(*,*) ' _\/\\\_______\/\\\_\/////\\\///__\///////\\\/////____/\\\///////\\\________/\\\\////__       '
if (myid_world.eq.0)  write(*,*) '  _\/\\\_______\/\\\_____\/\\\___________\/\\\________\///______/\\\______/\\\///_______      '
if (myid_world.eq.0)  write(*,*) '   _\/\\\\\\\\\\\\\\\_____\/\\\___________\/\\\_______________/\\\//_____/\\\\\\\\\\\____     '
if (myid_world.eq.0)  write(*,*) '    _\/\\\/////////\\\_____\/\\\___________\/\\\______________\////\\\___/\\\\///////\\\__    '
if (myid_world.eq.0)  write(*,*) '     _\/\\\_______\/\\\_____\/\\\___________\/\\\_________________\//\\\_\/\\\______\//\\\_   '
if (myid_world.eq.0)  write(*,*) '      _\/\\\_______\/\\\_____\/\\\___________\/\\\________/\\\______/\\\__\//\\\______/\\\__  '
if (myid_world.eq.0)  write(*,*) '       _\/\\\_______\/\\\__/\\\\\\\\\\\_______\/\\\_______\///\\\\\\\\\/____\///\\\\\\\\\/___ '
if (myid_world.eq.0)  write(*,*) '        _\///________\///__\///////////________\///__________\/////////________\/////////_____'
if (myid_world.eq.0)  write(*,*) '                                                                                              '

...
!================================================================================
  ...
  subroutine stat_velocity
    ...
    if (myid.eq.0) then
       ...
       inquire(file='../results/stat1.gp', exist=there, opened=there2)
       if (.not.there) then
          open(69,file='../results/stat1.gp',form='formatted')
          write(69,*) '# 1.itime 2.time         3.energy       4.diss         5.eta          6.enstrophy    7.R_lambda'
       end if
       if(there.and..not.there2) then
          open(69,file='../results/stat1.gp',position='append')
       end if
       ...
       inquire(file='../results/stat2.gp', exist=there, opened=there2)
       if (.not.there) then
          open(70,file='../results/stat2.gp',form='formatted')
          write(70,'(A)') '# 1.itime  2.time         3.int LS       4. lambda      5.R_lambda1    6.tau_e        7.etakmax'
       end if
       if(there.and..not.there2) then
          open(70,file='../results/stat2.gp',position='append')
       end if
       ...
       open(900,file='../results/es.gp',position='append')
       write(900,"()")
       write(900,"()")
